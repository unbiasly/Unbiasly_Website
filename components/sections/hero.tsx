      ...
      <div className="relative mx-auto max-w-[1440px] px-6 lg:px-10">
        ...
        >
          <p className="text-[16px] lg:text-[19px] leading-[1.55] text-white/65 text-pretty">
            UnbiaslyAI is India&apos;s first AI-powered news and content platform.
            It is built for{" "}
            <span className="text-white">900 million internet users</span> who
            want fast information with verified context. Every story arrives as
            a 60-word summary with the source clearly visible.
          </p>
        </div>
