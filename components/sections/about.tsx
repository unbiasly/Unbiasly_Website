          ...
          <div className="lg:col-span-7 order-2 lg:order-1">
            ...
            <div className="mt-10 space-y-6 max-w-2xl">
              <p className="text-[15px] lg:text-[17px] leading-[1.65] text-white/70">
                ...
                international sources, delivering easy-to-understand{" "}
                <span className="text-white">60-word summaries</span> with source
                verification. Our pipeline reads in the original Indian language
                wherever possible — instead of translating everything into
                English first — so bias that lives in idioms, honorifics, and
                local framing can be detected before it reaches you.
              </p>
              <p className="text-[15px] lg:text-[17px] leading-[1.65] text-white/70">
                We are{" "}
                <span className="text-white">recommendation-first, not publisher-first.</span>{" "}
                The feed learns what you read, skip, share, listen to, watch, and
                return to — then recommends source-attributed content in your
                preferred language and format. Over the next twelve months, the
                same verified stories will be available as text,{" "}
                ...
                provenance layer and earn through revenue-share as trusted
                inventory scales.
              </p>
            </div>
              ...
              <div className="flex flex-col gap-6">
                <div>
                  ...
                  <div className="mt-1.5 text-[14px] text-white/55">
                    Free · iOS, Android &amp; Indus AppStore · Hindi, English, Bangla
                  </div>
                </div>
