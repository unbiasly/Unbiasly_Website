...
const roadmap = [
  {
    ...
    items: [
      ...
      { label: "Audio", status: "12 months", title: "AI-generated audio", body: "Verified stories listenable in Indian languages. Powered by Sarvam APIs.", live: false },
      { label: "Video", status: "12 months", title: "AI anchor video", body: "Same trusted summary in 30 seconds. Provenance preserved across formats.", live: false },
    ],
  },
  {
    track: "Supply",
      ...
      <div className="mx-auto max-w-[1280px] px-5 sm:px-6 lg:px-10">
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 mb-12 lg:mb-16">
          ...
          <div className="lg:col-span-4 lg:col-start-9 lg:pt-3">
            <p className="text-[14px] sm:text-[15px] leading-[1.65] text-white/55">
              Over the next twelve months we extend verified content into audio and video, and open the platform to verified journalists, creators, and institutions.
            </p>
          </div>
        </div>
        ...
        <div className="text-center pt-20 lg:pt-28 mt-16 lg:mt-20 border-t border-white/[0.06]">
          ...
          <p className="mt-7 text-[14px] sm:text-[16px] lg:text-[17px] leading-[1.6] text-white/60 max-w-xl mx-auto text-pretty">
            Free. iOS, Android, Indus AppStore. 10,000+ stories a day with source attribution and framing analysis.
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4 sm:gap-5">
            ...
            <Link href="https://www.indusappstore.com/apps/news-magazines/unbiaslyai/com.unbiasly.app/" target="_blank" className="transition-transform hover:scale-[1.04]">
              <Image src={IndusStore} alt="Get it on Indus AppStore" className="h-12 sm:h-14 lg:h-16 w-auto" quality={100} />
            </Link>
          </div>
