        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 mb-12 lg:mb-16">
          <div className="lg:col-span-7">
            ...
            <h2 className="display text-[36px] sm:text-[44px] md:text-[52px] lg:text-[64px] leading-[0.98] tracking-tightest text-balance">
              Trust scales with{" "}
              <span className="display-italic text-white/55">verified supply.</span>
            </h2>
          </div>
          <div className="lg:col-span-4 lg:col-start-9 lg:pt-3">
            <p className="text-[14px] sm:text-[15px] leading-[1.65] text-white/55">
              The next layer is people. Verified regional journalists, domain experts, and institutions publishing through the same provenance layer, so trusted coverage scales without losing its source.
            </p>
          </div>
        </div>
