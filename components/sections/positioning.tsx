      ...
      <div className="mx-auto max-w-[1280px] px-5 sm:px-6 lg:px-10">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 mb-12 lg:mb-16">
          <div className="lg:col-span-8">
            <div className="eyebrow-ink mb-5">How we compare</div>
            <h2 className="display fluid-h2 tracking-tightest text-balance ink">
              A trust layer for the apps{" "}
              <span className="display-italic ink-60">readers already use.</span>
            </h2>
          </div>
          <div className="lg:col-span-4 lg:pt-3">
            <p className="fluid-lead ink-60">
              The problem in Indian news today is provenance, framing, and language. Here is where each platform stands.
            </p>
          </div>
        </div>
