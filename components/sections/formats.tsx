const formats = [
  {
    ...
    body: "Available now. Every story across Hindi, English, and Bangla appears as a scannable summary with full source attribution.",
    statusColor: "accent",
  },
  {
    label: "Audio",
    ...
    body: "Verified stories will be listenable in Indian languages, supporting commutes, kitchens, and accessibility. Powered by Sarvam APIs.",
    statusColor: "muted",
  },
  {
    label: "Video",
      ...
      <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="mt-8 text-[16px] lg:text-[18px] leading-[1.6] text-white/60 max-w-2xl mx-auto text-pretty">
            Text was the start. Over the next twelve months we will extend
            verified content into audio, video, and conversational interfaces.
            Provenance will be preserved across every format.
          </p>
        </div>
