const formats = [
  {
    ...
    body: "Available now. Every story across Hindi, English, and Bangla as a scannable summary with source attribution.",
    statusColor: "accent",
  },
  {
    label: "Audio",
  ...
  },
  {
    ...
    body: "Watch the same trusted summary you would read in thirty seconds. Same provenance layer, new format.",
    statusColor: "muted",
  },
];
