...
export default function ABCDEP() {
  return (
    <section id="abcdep" className="relative bg-black overflow-hidden border-t border-white/[0.06] py-20 sm:py-24 lg:py-32">
      <div
        aria-hidden
        className="absolute inset-0 -z-10"
        style={{
          background:
            "radial-gradient(ellipse 70% 50% at 50% 0%, rgba(230,72,30,0.22), transparent 60%), #17130E",
        }}
      />
