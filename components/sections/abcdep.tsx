      ...
      <div className="relative mx-auto max-w-[1440px] px-6 lg:px-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="mt-8 text-[16px] lg:text-[18px] leading-[1.6] text-white/60 max-w-2xl mx-auto text-pretty">
            Indian attention lives in six high frequency categories that
            existing news apps treat as side categories. We treat them as the
            main wedge. This is where Indians spend time every day, and it is
            also where framing, rumours, and misinformation spread fastest.
          </p>
        </div>
