const categories = [
  { letter: "A", name: "Astrology", note: "Daily forecasts, festival timing, and life event guidance." },
  { letter: "B", name: "Bollywood", note: "Film, music, celebrity culture, and OTT releases." },
  { letter: "C", name: "Cricket", note: "Live scores, match reports, IPL coverage, and player news." },
  { letter: "D", name: "Devotion", note: "Religious updates, temple events, and sacred calendars." },
  { letter: "E", name: "Economics", note: "Markets, policy, business, and personal finance." },
      ...
      <div className="relative mx-auto max-w-[1440px] px-6 lg:px-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="mt-8 text-[16px] lg:text-[18px] leading-[1.6] text-white/60 max-w-2xl mx-auto text-pretty">
            It lives in six high frequency categories that most news apps treat
            as secondary. We treat them as the main wedge because this is where
            Indians spend time every day, and where framing, rumours, and
        ...
        <div className="mt-20 lg:mt-28 max-w-5xl mx-auto text-center">
          <div className="display-italic text-3xl md:text-4xl lg:text-5xl leading-[1.2] text-white/85 text-balance">
            ...
            language in Hindi or Bangla cannot be reliably detected by
            translating to English first because bias lives in idioms,
            implication, honorifics, and local framing.&rdquo;
          </div>
