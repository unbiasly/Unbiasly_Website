          ...
          <div className="grid lg:grid-cols-12 gap-10 mb-20 lg:mb-28">
            ...
            <div className="lg:col-span-3 lg:col-start-10 lg:pt-3">
              <p className="text-[15px] leading-[1.65] text-white/55">
                Two ends of the same problem. Umesh comes from Carnegie Mellon.
                Ashwani has worked on the ground across millions of citizens.
                Together they have spent eighteen months building this, always
                in person.
              </p>
            </div>
          </div>
