...
const founders: Founder[] = [
  ...
  },
  {
    ...
    role: "Co-Founder, COO",
    pedigree: "16 yrs, Govt of India",
    bio: "Owns strategy, growth, distribution, partnerships, editorial. Also founder of Green Governance India.",
  ...
  },
  {
    ...
    bio: "Owns revenue, partnerships, GTM. Leads B2B verification pilots and institutional channels.",
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-10 mb-12 lg:mb-16">
          ...
          <div className="lg:col-span-3 lg:col-start-10 lg:pt-3">
            <p className="text-[14px] sm:text-[15px] leading-[1.65] ink-60">
              Two ends of the same problem. Carnegie Mellon on the model side; Government of India on distribution. Eighteen months together, always in person.
            </p>
          </div>
        </div>

        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-black/[0.08] border rule-ink rounded-2xl overflow-hidden">
          {founders.map((f) => (
            <Link
              key={f.name}
              href={f.contactUrl}
              target="_blank"
              rel="noreferrer"
              className="group bg-[#F5F1EA] p-7 sm:p-8 hover:bg-white/60 transition-colors"
            >
