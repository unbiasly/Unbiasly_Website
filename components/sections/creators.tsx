...
const pillars = [
  {
    ...
    body: "Verified regional journalists publish directly through our provenance layer. Their stories carry source attribution, framing analysis, and native language coverage from day one.",
  },
  {
    label: "Creators",
    title: "Domain experts, monetised.",
    body: "We are onboarding verified creators across the ABCDEP categories. Creators earn through a revenue share model as trusted inventory scales, while provenance is preserved.",
  },
  {
    label: "Institutions",
    title: "Public information, properly distributed.",
    body: "Government departments, public information channels, and civic bodies can reach citizens through verified channels in their native language.",
  },
];
        ...
        <div className="grid lg:grid-cols-12 gap-10 mb-16 lg:mb-24">
          ...
          <div className="lg:col-span-4 lg:col-start-9 lg:pt-3">
            <p className="text-[15px] leading-[1.65] text-white/55">
              ...
              provenance layer that powers our news feed. They will earn through
              a revenue share model as trusted inventory grows.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 lg:mt-20 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 p-8 lg:p-10 rounded-2xl border border-white/10 bg-white/[0.02]">
          <div>
            ...
            <div className="mt-2 text-[14px] text-white/55">
              Early access applications are open. We will be in touch.
            </div>
          </div>
          <Link
