const steps = [
  {
    n: "01",
    title: "Ingest",
    body: "Pull stories from authentic Indian and international sources — around 10,000 articles a day across Hindi, English, and Bangla.",
  },
  {
    n: "02",
    title: "Analyse in language",
    body: "Read in the original Indic language wherever possible. Bias lives in idioms, honorifics, and local framing — translating to English first loses it.",
  },
  {
    n: "03",
    title: "Attribute & flag",
    body: "Every claim tied back to its source. Loaded language, one-sided framing, missing attribution, and unsupported claims flagged before content reaches the feed.",
  },
  {
    n: "04",
    title: "Summarise",
    body: "Condense each story to a 60-word summary with the source visible. Read it, click through, decide for yourself.",
  },
];
      ...
      <div className="mx-auto max-w-[1440px] px-6 lg:px-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="mt-8 text-[16px] lg:text-[18px] leading-[1.6] text-white/60 max-w-2xl mx-auto text-pretty">
            Most misinformation in India doesn&apos;t start as completely fake
            news. It starts as selective framing, emotional phrasing, missing
            context, or source-less forwarding. Four stages of work between a
            publisher hitting publish and a reader seeing the story.
          </p>
        </div>
        ...
        <div className="mt-20 lg:mt-28 grid grid-cols-2 lg:grid-cols-4 gap-y-10 gap-x-8 max-w-5xl mx-auto text-center">
          <div>
            <div className="display text-5xl lg:text-6xl">15–30 min</div>
