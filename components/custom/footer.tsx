    ...
    <footer className="relative bg-black text-white border-t border-white/10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-10 lg:gap-12">
          <div className="col-span-2 lg:col-span-4">
            ...
            <p className="mt-6 text-[14px] leading-relaxed text-white/55 max-w-xs">
              India&apos;s trust layer for news and content. Verified sources,
              native Indic-language framing analysis, 60-word clarity.
            </p>
      ...
      <div className="border-t border-white/10 overflow-hidden">
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10 py-12 lg:py-16">
          <div className="display text-[18vw] lg:text-[14vw] leading-[0.8] tracking-tightest text-white/[0.05] select-none whitespace-nowrap -ml-2">
            Unbiasly<span className="display-italic">AI</span>
          </div>
        </div>
      </div>
