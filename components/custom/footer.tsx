...
export default function Footer() {
  return (
    <footer className="relative bg-black text-white border-t border-white/10">
      {/* Subscribe block — one compact row */}
      <div className="mx-auto max-w-[1440px] px-6 lg:px-10 pt-14 lg:pt-20 pb-12 lg:pb-16">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 lg:items-end">
          <div className="lg:col-span-7">
            <div className="eyebrow mb-4">The Bulletin</div>
            <h2 className="display text-3xl md:text-4xl lg:text-5xl leading-[0.98] tracking-tightest text-balance">
              Get the briefing.{" "}
              <span className="display-italic text-white/55">
                Source-attributed, weekly.
              </span>
            </h2>
            <p className="mt-4 text-white/55 max-w-xl text-[14px] leading-relaxed">
              A weekly dispatch from New Delhi on what India read, what was framed
              honestly, and what was not. Free, no spam, one click to leave.
            </p>
          </div>
      ...
      <div className="mx-auto max-w-[1440px] px-6 lg:px-10 py-14 lg:py-20">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-10 lg:gap-12">
          <div className="col-span-2 lg:col-span-4">
            ...
            <div id="get-app" className="mt-6 flex items-center gap-2.5 scroll-mt-24">
              <a
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-[1440px] px-6 lg:px-10 py-6 flex flex-col-reverse md:flex-row items-center justify-between gap-4">
          <div className="text-[12px] text-white/45 mono">
            © 2026 Triverge Insight Private Limited &nbsp;|&nbsp;{" "}
            {links.legal.map((l, i) => (
              <span key={l.href}>
