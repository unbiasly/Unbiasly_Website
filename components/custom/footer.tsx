        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20">
          <div className="lg:col-span-7">
            ...
            <p className="mt-6 text-white/55 max-w-xl text-[15px] leading-relaxed">
              A weekly dispatch from New Delhi covering what India read, what was framed honestly, and what needed more context. Free to read and easy to unsubscribe from.
            </p>
          </div>
